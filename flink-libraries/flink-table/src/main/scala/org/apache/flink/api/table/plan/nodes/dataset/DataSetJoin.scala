...
import org.apache.flink.api.table.plan.nodes.dataset.forwarding.FieldForwardingUtils.{getForwardedFields, getForwardedInput}
...
class DataSetJoin(
  ...
  override def translateToPlan(
    ...
    joinOperator.where(leftKeys.toArray: _*)
